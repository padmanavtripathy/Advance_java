...
public class MyServiceServiceLocator extends org.apache.axis.client.Service implements mywebservice1.com.web.service.MyServiceService {
    ...
    private java.lang.String MyService_address = "http://localhost:8181/mywebservice1/services/MyService";
    ...
    public mywebservice1.com.web.service.MyService getMyService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mywebservice1.com.web.service.MyServiceSoapBindingStub _stub = new mywebservice1.com.web.service.MyServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mywebservice1.com.web.service.MyService.class.isAssignableFrom(serviceEndpointInterface)) {
                mywebservice1.com.web.service.MyServiceSoapBindingStub _stub = new mywebservice1.com.web.service.MyServiceSoapBindingStub(new java.net.URL(MyService_address), this);
                _stub.setPortName(getMyServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.web.com.mywebservice1", "MyServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.web.com.mywebservice1", "MyService"));
        }
